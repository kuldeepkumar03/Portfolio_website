...
function initWhatsAppContact() {
  const links = $$('a[href*="wa.me"], a[href*="api.whatsapp.com"]');
  links.forEach(link => {
    const label = link.textContent?.trim() || '';
    if (!label || label !== 'Say Hello') return;
    ...
    link.addEventListener('click', (e) => {
      ...
      const message = `Hello Kuldeep, I am ${name}. Let's discuss something interesting related to AI and ML`;
